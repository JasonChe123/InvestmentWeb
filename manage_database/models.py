...
class IncomeStatement(models.Model):
    ...
    BasicEarningPerShareEPS = models.DecimalField(max_digits=20, decimal_places=2, null=True)
    DilutedEarningPerShareEPS = models.DecimalField(max_digits=20, decimal_places=2, null=True)
    BasicWeightedAverageShares = models.BigIntegerField(null=True)
    DilutedWeightedAverageShares = models.BigIntegerField(null=True)
    DividendsPerShareDPS = models.DecimalField(max_digits=20, decimal_places=2, null=True)
